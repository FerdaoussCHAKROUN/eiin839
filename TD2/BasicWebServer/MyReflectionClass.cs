...
namespace MRC
{
    public class MyReflectionClass
    {
        ...
        public string ExecCreation()
        {
            ...
            start.FileName = @"C:\Users\user\Documents\SI4_2\SOC\TDrendu\eiin839\TD2\ExecCreation\bin\Debug\netcoreapp3.1\ExecCreation.exe"; // Specify exe name.
        ...
        public string incr()
        {
            string filepath = @"C:\Users\user\Documents\SI4_2\SOC\TDrendu\eiin839\TD2\BasicWebServer\incr.txt";
            string result;
